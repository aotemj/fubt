    ...
    <div class="inner-content">
      ...
      <div class="left">
        ...
        <div class="nav">
          <ul class="">
            <li class="fl">
              <router-link v-bind:class="{active:activeRoute=='home'}" data-no="1" to="/">{{$t('m.home')}}</router-link>
            </li>
            <li class="fl">
              <router-link v-bind:class="{active:activeRoute=='exchange'}" data-no="2" to="/exchange">
                {{$t('m.tradingCenter')}}
              </router-link>
            </li>
            <li class="fl finance-center" v-on:mouseover="showLink" v-on:mouseleave="hideLink">
              <router-link v-bind:class="{active:activeRoute=='finance'}" data-no="3" to="/finance">
                {{$t('m.financeCenter')}}
              </router-link>
            </li>
            <li class="fl">
            ...
            <li class="fl">
              <router-link v-bind:class="{active:activeRoute=='newCoins'}" data-no="5" to="/newCoins">
                {{$t('m.voteForNewCurrency')}}
              </router-link>
            </li>
            <li class="fl">
              <router-link v-bind:class="{active:activeRoute=='news'}" data-no="6" to="/news">{{$t('m.news')}}
              </router-link>
            </li>
            <li class="fl">
              <router-link v-bind:class="{active:activeRoute=='c2c'}" data-no="7" to="/c2c">{{$t('m.C2C')}}
              </router-link>
            </li>
          </ul>
        </div>
        ...
        <div class="change-lang fl" v-on:mouseover="showCountryList" v-on:mouseleave="hideCountryList">
          ...
          <div class="country-list" v-show="countryListIsShow">
            <ul v-on:mouseleave="hideCountryList">
              <li class="clearfix" v-on:click="chooseLang('zh-CN')"><span class="fl">简体中文</span> <i
                class="fr country chinese"></i></li>
              <li class="clearfix" v-on:click="chooseLang('en-US')"><span class="fl">English</span> <i
                class="fr country english"></i></li>
              <li class="clearfix" v-on:click="chooseLang('zh-FN')"><span class="fl">繁體中文</span> <i
                class="fr country fanti"></i></li>
            </ul>
          </div>
        </div>
      </div>
...
<style scoped>
  ...
  .nav ul li a:hover, .login ul li a:hover, .country-list ul li:hover {
    color: #407edf;
  }
